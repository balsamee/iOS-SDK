...
//
#import "VideoExtensionController.h"

@implementation VideoExtensionController
                ...
                completionBlock:(CompletedPostApiV5VideoExtensionsPost) onCompleted
{
    ...
    [_queryBuilder appendString: @"/video_extensions"];
                ...
                completionBlock:(CompletedGetApiV5VideoExtensions76Get) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/video_extensions/76"];
