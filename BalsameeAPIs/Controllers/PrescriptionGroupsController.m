...
//
#import "PrescriptionGroupsController.h"

@implementation PrescriptionGroupsController
                ...
                completionBlock:(CompletedGetApiV5PrescriptionGroupsGet) onCompleted
{
    ...
    [_queryBuilder appendString: @"/prescription_groups"];
                ...
                completionBlock:(CompletedGetApiV5ReservationRequests4271PrescriptionGroupsGet) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/reservation_requests/4271/prescription_groups"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             ListPrescriptionsgroupsundercertainclinicvisit* _result = (ListPrescriptionsgroupsundercertainclinicvisit*) [APIHelper jsonDeserialize: _strResult
                toClass: ListPrescriptionsgroupsundercertainclinicvisit.class];
