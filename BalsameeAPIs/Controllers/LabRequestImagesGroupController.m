...
//
#import "LabRequestImagesGroupController.h"

@implementation LabRequestImagesGroupController
                ...
                completionBlock:(CompletedPostApiV5LabRequestImagesGroupsPost) onCompleted
{
    ...
    [_queryBuilder appendString: @"/lab_request_images_groups"];
    ...
    [_parameters addEntriesFromDictionary: @{
        @"lab_request_images_group[lab_request_images_attributes][][image]": labRequestImagesGroupLabRequestImagesAttributesImage
    }];
